            ...
            <form method="GET" action="{{ route('sales.index') }}" class="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="flex flex-wrap items-center gap-2 sm:col-span-2 lg:col-span-4">
                    ...
                    <span class="ml-auto flex items-center gap-2">
                        <x-button :href="route('sales.export.pdf', $exportQuery)" variant="secondary" size="sm" icon="download">{{ __('app.actions.export_pdf') }}</x-button>
                        <x-button :href="route('sales.export.excel', $exportQuery)" variant="secondary" size="sm" icon="download">{{ __('app.actions.export_excel') }}</x-button>
                    </span>
                </div>
            </form>
        </x-card>
