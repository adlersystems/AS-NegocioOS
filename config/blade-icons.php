    ...
    */
    ...
    'components' => [
        ...
        */
        ...
        |
        | Set to null because the application renders icons through its own
        | custom <x-icon> component (resources/views/components/icon.blade.php),
        | which dispatches to the svg() helper internally. Disabling the
        | package's generic component avoids a name collision on <x-icon>.
        |
        */
